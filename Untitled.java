#!/usr/bin/env python3
"""
Real-time obstacle detection visualizer
2 panels:
  Left  — full costmap + bounding box + circle filter
  Right — CLEAN background, only obstacle circles + centres (no costmap image)
"""
