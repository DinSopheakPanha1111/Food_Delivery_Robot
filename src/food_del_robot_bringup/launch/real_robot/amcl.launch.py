...
def generate_launch_description():
    ...
    rviz_config_path = os.path.join(desc, 'rviz', 'robot_amcl.rviz')
    ...
    lifecycle_config_path = os.path.join(bringup, 'config', 'real_robot', 'lifecycle_manager', 'lifecycle_manager_for_amcl.yaml')
    ...
    return LaunchDescription([
        ...
        Node(package='zlac8015d_driver', executable='drive_and_odom', name='drive_and_odom_v2', output='screen'),
