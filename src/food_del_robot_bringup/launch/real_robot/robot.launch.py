...
def generate_launch_description():
    ...
    controller_config_path = os.path.join(bringup, 'config', 'real_robot', 'controller_server', 'dwb_config.yaml')
    planner_config_path = os.path.join(bringup, 'config', 'real_robot', 'planner_server', 'A_star_config.yaml')
