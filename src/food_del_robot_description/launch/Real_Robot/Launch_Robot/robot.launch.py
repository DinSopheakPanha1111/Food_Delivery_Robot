...
def generate_launch_description():
    ...
    map_yaml_path = os.path.join(home, 'Food_Delivery_Robot/src/food_del_robot/maps/Class_map/class_map.yaml')
    amcl_config_path = os.path.join(home, 'Food_Delivery_Robot/src/food_del_robot/config/Real_Robot/AMCL/amcl_config.yaml')
    controller_config_path = os.path.join(home, 'Food_Delivery_Robot/src/food_del_robot/config/Real_Robot/Controller_Server/dwb_config.yaml')
    planner_config_path = os.path.join(home, 'Food_Delivery_Robot/src/food_del_robot/config/Real_Robot/Planner_Server/A_star_config.yaml')
    bt_navigator_config_path = os.path.join(home, 'Food_Delivery_Robot/src/food_del_robot/config/Real_Robot/BT_Navigator/bt_navigator_config.yaml')
    lifecycle_manager_config_path = os.path.join(home, 'Food_Delivery_Robot/src/food_del_robot/config/Real_Robot/Lifecycle_manager/lifecycle_manager_config.yaml')
