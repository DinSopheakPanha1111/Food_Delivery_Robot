...
def generate_launch_description():
    ...
    lifecycle_manager_config_path = os.path.join(
        home,
        'Food_Delivery_Robot/src/food_del_robot_description/config/lifecycle_manager.yaml'
    )
                ...
                Node(
                    ...
                    parameters=[{
                        'yaml_filename': os.path.join(
                            home,
                            'Food_Delivery_Robot/src/food_del_robot_description/maps/food_del_sim_map.yaml'
                        )
                    }]
                )
            ]
